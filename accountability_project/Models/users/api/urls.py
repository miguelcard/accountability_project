...
from Models.users.api.api import LoggedInUserApiView, UpdateLoggedInUserApiView, UserGenericApiView, UpdateUserWithoutPasswordApiView, GetAllUserTagsApiView, GetAllUserLanguagesApiView
...
urlpatterns = [
    ...
    path('v1/users/update/<int:pk>', UpdateUserWithoutPasswordApiView.as_view()), # Only visible to admins
