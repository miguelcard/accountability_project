...
from Models.users.views import RegisterAPI, LoginAPI, CustomLogoutView, CustomLogoutAllView
...
urlpatterns = [
    ...
    path('v1/logout/',CustomLogoutView.as_view(), name='logout'),
    path('v1/logoutall/', CustomLogoutAllView.as_view(), name='logoutall'),
